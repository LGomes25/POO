...
public class TestePessoa {
	...
	public static void main(String[] args) {
		...
		System.out.println(pessoa1.getNome() + ", você está com " + pessoa1.resultado());
		System.out.println(pessoa2.getNome() + ", você está com " + pessoa2.resultado());

		System.out.println(pessoa1==pessoa2 ? "Iguais" : "Diferentes");
		System.out.println(pessoa1.getNome().equals(pessoa2.getNome()));
		System.out.println(pessoa1);//puxa posição de memória
		System.out.println(pessoa2);//puxa posição de memória
	}
